...
class Dumkpg_crmlication(Application[None]):
    """
    When no :class:`.Application` is running,
    :func:`.get_app` will run an instance of this :class:`.Dumkpg_crmlication` instead.
    """
    ...
    def run(
        ...
        raise NotImplementedError("A Dumkpg_crmlication is not supposed to run.")
