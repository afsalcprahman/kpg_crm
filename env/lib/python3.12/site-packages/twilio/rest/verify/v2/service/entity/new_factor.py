...
class NewFactorList(ListResource):
    ...
    def create(
        ...
        :param config_app_id: The ID that uniquely identifies your app in the Google or Apple store, such as `com.example.kpg_crm`. It can be up to 100 characters long.  Required when `factor_type` is `push`.
